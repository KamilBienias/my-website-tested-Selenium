...
public class Quiz2 extends BasePage {
    ...
    @Step
    public QuizResults openQuizResultsPageWithGoodAnswer2a() {
        captureScreenshot();
    ...
    @Step
    public QuizResults openQuizResultsPageWithBadAnswer2b() {
        captureScreenshot();
        JavascriptExecutor js = (JavascriptExecutor) WebDriverSingleton.getDriver();
    ...
    @Step
    public QuizResults openQuizResultsPageWithBadAnswer2c() {
        captureScreenshot();
        JavascriptExecutor js = (JavascriptExecutor) WebDriverSingleton.getDriver();
