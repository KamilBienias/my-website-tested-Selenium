...
public class Quiz4 extends BasePage{
    ...
    @Step
    public QuizResults openQuizResultsPageWithBadAnswer4a() {
        captureScreenshot();
    ...
    @Step
    public QuizResults openQuizResultsPageWithBadAnswer4b() {
        captureScreenshot();
        JavascriptExecutor js = (JavascriptExecutor) WebDriverSingleton.getDriver();
    ...
    @Step
    public QuizResults openQuizResultsPageWithGoodAnswer4c() {
        captureScreenshot();
        JavascriptExecutor js = (JavascriptExecutor) WebDriverSingleton.getDriver();
